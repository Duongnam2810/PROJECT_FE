...
export const API_BALL_URL = new InjectionToken<string>('API_BALL_URL');

@Injectable({
    providedIn: 'root'
})
export class BallApiService {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;

    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BALL_URL) baseUrl?: string) {
        this.http = http;
